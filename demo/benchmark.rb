...
GrnMini::tmpdb do
  ...
  # The data file is generated by: https://github.com/droonga/wikipedia-search
  # Format:
  #   load --table Pages
  #   [
  #     {"_key":1,"title":"aaaa","text":"bbbb"},
  #     {"_key":2,"title":"cccc","text":"dddd"},
  #     ...
  #     {"_key":1000,"title":"eeee","text":"ffff"}
  #   ]
